...
//! So templateRef is what we want rendered and vcRef is where we want to render it.
...
// standalone component added in angular 14
//!-------------------------------------------------------------------------------------------------------------------------------------------------------------------//
//! 347: Building a First Standalone Component
// when we make component standalone component and remove it from declarations in app.module.ts we should add it in import in app.module.ts
// in this case this component can't see the module or directives or pipes that we import in app.module.ts so we import them in the component itself
//!-------------------------------------------------------------------------------------------------------------------------------------------------------------------//
